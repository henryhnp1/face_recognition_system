...
--
-- Table structure for table `role_door`
--
...
--
-- Dumping data for table `role_door`
--

LOCK TABLES `role_door` WRITE;
/*!40000 ALTER TABLE `role_door` DISABLE KEYS */;
INSERT INTO `role_door` VALUES (1,'PUBLIC','Cho phép mọi người qua cửa'),(2,'RESTRICT','Chỉ những người có quyền mời được qua cửa');
/*!40000 ALTER TABLE `role_door` ENABLE KEYS */;
UNLOCK TABLES;
