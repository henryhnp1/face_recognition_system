...
def security_guest_clear_form(self):
    ...
    self.security_guest_image_clear_form()

def load_security_guest(self):
    self.security_guest_guest_visit_load()
    self.security_guest_image_load()
...
def security_guest_handle_button(self):
    ...
    self.security_guest_image_handle_button_guest_image_tab()
...
def security_guest_handle_combobox(self):
    ...
    self.security_guest_image_handle_combobox_guest_image_tab()
...
def security_guest_combobox_setting(self):
    ...
    self.security_guest_image_combobox_setting_guest_image_tab()
...
def security_guest_combobox_setting_data_change(self):
    ...
    self.security_guest_image_combobox_setting_data_change_guest_image_tab()
...
def security_guest_handle_search_line_edit(self):
    ...
    self.security_guest_image_handle_search_line_edit_guest_image_tab()
...
def security_guest_table_widget_setting(self):
    ...
    self.security_guest_image_table_widget_setting_guest_image_tab()
...
def security_guest_button_setting_and_ui(self):
    ...
    self.security_guest_image_button_setting_and_ui_guest_image_tab()
